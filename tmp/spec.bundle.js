...
/* proxyquireify injected requires to make browserify include dependencies in the bundle */;require('../src/js/tasks');var proxyquire = require('proxyquireify')(require);
...
},{"../src/js/tasks":7,"proxyquireify":2}],5:[function(require,module,exports){
"use strict";
...
exports.remove = function(clickEvent) {
    ...
    $(taskElement).closet('.task').remove();
};
